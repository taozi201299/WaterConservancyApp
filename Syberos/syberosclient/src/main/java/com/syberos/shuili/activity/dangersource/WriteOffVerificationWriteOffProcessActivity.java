 ...
 * 该文件暂不使用
 */
public class WriteOffVerificationWriteOffProcessActivity extends BaseActivity {
    ...
    public int getLayoutId() {
        return R.layout.activity_write_off_verification_write_off_process;
    }
    ...
    private class StepsInfoListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ViewHolder holder;
            if (null == convertView) {
                convertView = LayoutInflater.from(WriteOffVerificationWriteOffProcessActivity.this)
