 ...
 * 文件暂不使用
 */
public class QueryAccidentListActivity extends BaseActivity
    ...
    QueryAccidentListAdapter accidentInformationListAdapter;
    List<ObjAcci> accidentInformationList = null;

    @Override
    public int getLayoutId() {
        return R.layout.activity_query_accident_list;
    }
    ...
    public void initView() {
        ...
        accidentInformationListAdapter = new QueryAccidentListAdapter(this,
                R.layout.activity_query_accident_list_item);
    ...
    public void onItemClick(int position) {
        ...
        intentActivity(this, QueryAccidentDetailActivity.class, false, bundle);
    }

    private class QueryAccidentListAdapter extends CommonAdapter<ObjAcci> {
        public QueryAccidentListAdapter(Context context, int layoutId) {
