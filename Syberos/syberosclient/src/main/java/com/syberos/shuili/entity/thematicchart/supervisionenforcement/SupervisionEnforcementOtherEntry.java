 ...
 * Package：com.syberos.shuili.entity.thematicchart.supervisionenforcement.
 */
public class SupervisionEnforcementOtherEntry {
    //    监督执法
    ...
    //监督执法情况
    List<ProjectOtherEntry> projectOtherEntryList;

    private class ProjectOtherEntry {
        String name;//辖区
        String ticketCount;//处罚单
        String rectifyCount;//整改单
    }
}
