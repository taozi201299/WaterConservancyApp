 ...
 * 该文件暂不使用
 */
public class RecordReviewProcessActivity extends BaseActivity {
    ...
    public int getLayoutId() {
        return R.layout.activity_record_review_process;
    }
    ...
    public void initView() {
        ...
        for (int i = 1; i <= 9; ++i) {
            ...
            stepInfo.setStepTitle("备案申请 0" + i);
    ...
    private class StepsInfoListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ViewHolder holder;
            if (null == convertView) {
                convertView = LayoutInflater.from(RecordReviewProcessActivity.this).inflate(
                        R.layout.widget_vertical_steps_item, null);
