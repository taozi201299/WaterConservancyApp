...
public class RecordReviewHistoryPatrolListActivity extends BaseActivity
        implements CommonAdapter.OnItemClickListener {

    private final String TAG = RecordReviewHistoryPatrolListActivity.class.getSimpleName();
    ...
    public int getLayoutId() {
        return R.layout.activity_record_review_history_patrol_list;
    }
    ...
    public void onItemClick(int position) {
        ...
        intentActivity(this, RecordReviewHistoryPatrolDetailActivity.class, false, bundle);
    }
