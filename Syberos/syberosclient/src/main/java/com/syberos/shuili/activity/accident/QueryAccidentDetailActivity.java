 ...
 * 文件暂不使用
 */
public class QueryAccidentDetailActivity extends BaseActivity implements View.OnClickListener {
    private final String TAG = QueryAccidentDetailActivity.class.getSimpleName();
    ...
    public int getLayoutId() {
        return R.layout.activity_query_accident_detail;
    }
    ...
    public void initView() {
        ...
        if (null != accidentInformation) {
            // TODO: 2018/4/12 事故名稱 未返回
            setActionBarTitle("未知");
            tv_accident_unit.setText(accidentInformation.getAcciWindGuid());
            tv_accident_name.setText("缺少該字段");
