...
public class LogUtils {
	...
	private static String MYLOGFILEName = "RainbowBusLog.txt";// 本类输出的日志文件名称
	...
	private static void writeLogtoFile(String mylogtype, String tag, String text) {
		...
		File file = new File(Environment.getExternalStorageDirectory(), needWriteFiel + MYLOGFILEName);
		try {
