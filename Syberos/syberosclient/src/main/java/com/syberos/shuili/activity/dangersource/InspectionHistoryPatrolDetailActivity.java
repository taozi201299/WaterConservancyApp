 ...
 * 该文件暂不使用
 */
public class InspectionHistoryPatrolDetailActivity extends BaseActivity {

    private final String TAG = InspectionHistoryPatrolDetailActivity.class.getSimpleName();
    ...
    public int getLayoutId() {
        return R.layout.activity_inspection_history_patrol_detail;
    }
