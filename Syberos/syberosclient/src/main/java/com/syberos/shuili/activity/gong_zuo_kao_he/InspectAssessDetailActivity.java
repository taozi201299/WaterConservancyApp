...
import com.syberos.shuili.entity.gong_zuo_kao_he.InspectAssessInfo;
import com.syberos.shuili.entity.gong_zuo_kao_he.InspectionObjectInfo;
...
public class InspectAssessDetailActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        if (null != info) {
            ...
            List<InspectAssessInfo> inspectAssessInfoList = info.getInspectAssessInfoList();
            for (final InspectAssessInfo objectInfo : inspectAssessInfoList) {
                View view = LayoutInflater.from(mContext).inflate(
                        R.layout.activity_inspect_assess_detail_check_item, null);
            ...
            for (final DeductMarksInfo marksInfo : deductMarksInfoList) {
                View view = LayoutInflater.from(mContext).inflate(
                        R.layout.activity_inspect_assess_detail_deduct_marks, null);
                ...
                view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intentActivity((Activity) mContext,
                                InspectAssessDetailDeductMarksActivity.class,
                                false, bundle);
                    }
                });
