...
public class BisHazRegDetail extends HttpBaseResponse<BisHazRegDetail> {
     ...
     public String proPart;
     public String recPers;
     public String partLong;
     public String legPers;
     public String evaOrgName;
     public String hazName;
     public String wiunName;
     public String patPers;
     public String hazStat;
     public String note;
     public String orgGuid; // 报备单位orgGUID
     public String offiTel;
     public String writeCode;
     public String regTime;
     public String hazCode;
     public String idenEvaResu;
     public String collTime;
     public String harmRisk;
     public String ifLiceNoti;
     public String hiddGrad;
     public String regName;
     public String partLat;
     public String tendGuid;
     public String guid;
     public String updTime;
     public String writeName;
     public String engGuid;
     public String supPers;
