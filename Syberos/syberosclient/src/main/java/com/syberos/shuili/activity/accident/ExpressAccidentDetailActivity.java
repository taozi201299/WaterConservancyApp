 ...
 * 该文件暂不使用 和企事业端相同
 */
public class ExpressAccidentDetailActivity extends BaseActivity{

    private final String TAG = ExpressAccidentDetailActivity.class.getSimpleName();
    ...
    public int getLayoutId() {
        return R.layout.activity_express_accident_detail;
    }
    ...
    public void initView() {
        ...
        ObjAcci accidentInformation = (ObjAcci)bundle.getSerializable(
                ExpressAccidentListActivity.SEND_BUNDLE_KEY);
