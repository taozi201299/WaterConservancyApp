 ...
 * 该文件暂不使用
 */
public class RecordedRecordProcessActivity extends BaseActivity {
    ...
    public int getLayoutId() {
        return R.layout.activity_recorded_record_process;
    }
    ...
    private class StepsInfoListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ViewHolder holder;
            if (null == convertView) {
                convertView = LayoutInflater.from(RecordedRecordProcessActivity.this)
