...
public class SecurityCloudEntry implements Serializable {
    private SynthesisInfoEntry synthesisInfoEntry;//综合情况
    private AccidentInfoEntry accidentInfoEntry;//事故
    private HiddenInfoEntry hiddenInfoEntry;//隐患
    private RiskSourceEntry riskSourceEntry;//危险源
    private StraightTubeManageEntry straightTubeManageEntry;//直管的 “管理”数据
    private SupervisionMangeEntry supervisionMangeEntry;//监管 和 流域的 “管理”数据
    private CompScoreTrend compScoreTrend;  //综合得分 趋势
    private List<AreaRank> rankList;    //排名
