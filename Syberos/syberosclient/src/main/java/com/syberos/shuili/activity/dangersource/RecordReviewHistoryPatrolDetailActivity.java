 ...
 * 该文件暂不使用
 */
public class RecordReviewHistoryPatrolDetailActivity extends BaseActivity {

    private final String TAG = RecordReviewHistoryPatrolDetailActivity.class.getSimpleName();
    ...
    public int getLayoutId() {
        return R.layout.activity_record_review_history_patrol_detail;
    }
