...
/**
 *         部 本部门sourceType 1  subSourceType 监管2 流域3
 流域  sourceType 3  subSourceType 3
 监管  sourceType 2  subSourceType 2
 省,市 本部门 sourceType 1  subSouceType 2
 监管  sourceType 2  subSourceType 2
 流域,县  sourceType 1 subSourceType 1
 */

public class SinsChartFragment extends BaseLazyFragment implements  EasyPermissions.PermissionCallbacks {
    ...
    private void  setData(SinsEntry sinsEntry){
        this.sinsEntry = sinsEntry;
    }
    public SinsEntry getData(){
        return this.sinsEntry;
    }
    class Point {
