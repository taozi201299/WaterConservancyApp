 ...
 * 需要修改
 */
public class EnterprisesRatingReportActivity extends TranslucentActivity {
            ...
            tv_report.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    switch (linkStatus) {
                        case HiddenDangerReport.LINK_RETURNED:
                            if(hiddenDangerReport.isReportFinish()) {
                                confirmDialog = new Dialog(EnterprisesRatingReportActivity.this);
                                View v1 = LayoutInflater.from(EnterprisesRatingReportActivity.this).inflate(
