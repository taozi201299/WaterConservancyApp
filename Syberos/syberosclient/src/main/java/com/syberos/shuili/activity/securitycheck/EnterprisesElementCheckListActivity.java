...
public class EnterprisesElementCheckListActivity extends BaseActivity
    ...
    public void initView() {
        ...
        adapter = new ListAdapter(this,
                R.layout.activity_enterprises_element_check_list_item);
    ...
    private class ListAdapter extends CommonAdapter<ObjSe> {
        ...
        public void convert(ViewHolder holder, final ObjSe information) {
            ...
            switch (level) {
                case EnterprisesElementCheckInfo.LEVEL_NORMAL: {
                    ll_type.setBackground(getResources().getDrawable(
                            R.drawable.bg_enterprises_element_check_level_normal));
                }
                break;
                case EnterprisesElementCheckInfo.LEVEL_COMMON: {
                    ll_type.setBackground(getResources().getDrawable(
                            R.drawable.bg_enterprises_element_check_level_common));
                }
                break;
                case EnterprisesElementCheckInfo.LEVEL_NOT_SURE: {
                    ll_type.setBackground(getResources().getDrawable(
                            R.drawable.bg_enterprises_element_check_level_not_sure));
                }
                break;
                case EnterprisesElementCheckInfo.LEVEL_LARGE: {
                    ll_type.setBackground(getResources().getDrawable(
