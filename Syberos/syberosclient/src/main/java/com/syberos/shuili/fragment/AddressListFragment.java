 ...
 * 通讯录 for 行政
 */
public class AddressListFragment extends BaseFragment implements SideBar.OnTouchingLetterChangedListener, AdapterView.OnItemClickListener, ClearEditText.ITextChanged,ClearEditText.DeleteListener, View.OnClickListener, View.OnFocusChangeListener{
