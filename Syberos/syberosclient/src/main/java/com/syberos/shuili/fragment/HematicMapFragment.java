    ...
    void showCharView() {
        ...
        switch (tabTitle[currentItem]) {
            ...
            case Woas:
                break;
            case Wins:
                Bundle winsBundle = new Bundle();
                winsBundle.putSerializable("winsData",((WinsChartFragment)fragments.get(currentItem)).getData());
      ...
      //  params.put("type", "XZBAS");
        ...
        HttpUtils.getInstance().requestGet(url, params, url, new RequestCallback<String>() {
            ...
            public void onFailure(ErrorInfo.ErrorCode errorInfo) {
                ...
                ((HiddenChartFragment)fragments.get(0)).closeDataDialog();
                ((AccidentChartFragment)fragments.get(1)).closeDataDialog();
                ((HazChartFragment)fragments.get(2)).closeDataDialog();
                ((StanChartFragment)fragments.get(3)).closeDataDialog();
