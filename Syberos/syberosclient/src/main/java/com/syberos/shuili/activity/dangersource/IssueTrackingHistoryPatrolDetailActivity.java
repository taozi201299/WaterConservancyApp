 ...
 * 该文件暂不使用
 */
public class IssueTrackingHistoryPatrolDetailActivity extends BaseActivity {

    private final String TAG = IssueTrackingHistoryPatrolDetailActivity.class.getSimpleName();
    ...
    public int getLayoutId() {
        return R.layout.activity_issue_tracking_history_patrol_detail;
    }
